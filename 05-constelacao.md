...
Cada posição tem **2 slots**: Esquerdo (LEFT) e Direito (RIGHT).
...
Quando os teus 2 slots estão ocupados, novos membros vão para o primeiro slot livre abaixo de ti. O sistema alterna os lados automaticamente para manter o equilíbrio.

> O teu **padrinho** (quem te convidou) pode ser diferente da tua posição na Constelação. Isso é completamente normal.
